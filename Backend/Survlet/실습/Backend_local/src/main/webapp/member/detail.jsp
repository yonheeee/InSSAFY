...
<div align="center">
	<h1>회원상세</h1>
	<form action="/Backend_local/member?action=update" method="post">
	
	<table border="1px; solid; #000">
		<tr><td>id</td><td><input type="text" readonly="readonly "name="id" value="<%=mem.getId() %>" /></td></tr>
<%-- 		<tr><td>password</td><td><input type="text" name="password" value="<%=mem.getPassword() %>" /></td></tr> --%>
		...
		<tr><td colspan="2"><input type="submit" value="수정" /><input type="button" value="deletemember()" value="삭제"/></td></tr>
	</table>
